...
credit_after_3 = random_credit_amount - (crew_numbers * 3)
total_crew = crew_numbers + 2
yondu_13_percent = yondu_13_percent = credit_after_3 * 0.13
after_yondu = credit_after_3 - yondu_13_percent
...
yondu_total = round(yondu_13_percent, 2) + round(split_price, 2)
